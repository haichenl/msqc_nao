...
while (~finished)  % Step 11 -- Test convergence
    ...
    obj.J = reshape(reshape(H2, obj.nbasis.^2, obj.nbasis.^2) * reshape(P, obj.nbasis.^2, 1), obj.nbasis, obj.nbasis);
    obj.K = reshape(-reshape(permute(H2,[1 4 2 3]), obj.nbasis.^2, obj.nbasis.^2)./2 * reshape(P, obj.nbasis.^2, 1), obj.nbasis, obj.nbasis);
